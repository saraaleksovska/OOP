...
public:
    OnlineBook(const char *isbn=" ", const char *naslov="", const char *avtor="", float cena=0.0, const char *url="", int mb=0) : Book(isbn, naslov, avtor, cena){
...
private:
    ...
    bool zaliha;
public:
    PrintBook(const char *isbn=" ", const char *naslov="", const char *avtor="", float cena=0.0, float masa=0.0, bool zaliha= true) : Book(isbn, naslov, avtor, cena){
        this->masa=masa;
        this->zaliha=zaliha;
    }
    float bookPrice() override{
